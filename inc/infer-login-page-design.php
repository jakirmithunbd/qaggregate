...
function verp_custom_login_page() {
    echo '<style type="text/css">
	    ...
	    .login { 
	    	background-image:url("'. get_stylesheet_directory_uri().'/assets/images/banner.jpg") !important; 
        ...
        .login h1 a {
        	background-image: url('. get_stylesheet_directory_uri().'/assets/images/logo.svg) !important; 
        	width: 100% !important; 
        	margin: 0 auto !important; 
